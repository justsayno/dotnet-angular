...
module.exports = class AzureBlobStorageClient {
  constructor(storageAccountName, storageAccountKey) {
    if (storageAccountName == null) throw new Error('You must supply a "storageAccountName"');
    if (storageAccountKey == null) throw new Error('You must supply a "storageAccountKey"');
